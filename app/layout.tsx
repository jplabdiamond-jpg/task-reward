...
export const metadata: Metadata = {
  ...
  description: 'タスク・アンケート・動画視聴で報酬を獲得できる業務委託型プラットフォーム。PayPal・銀行振込・Amazonギフト券・暗号通貨へ最低5,000円から即時交換可能。',
  ...
  openGraph: {
    ...
    description: 'タスク・アンケート・動画視聴で報酬を獲得。PayPal・銀行振込・Amazonギフト券へ最低5,000円から即時交換。',
    images: [
  ...
  twitter: {
    ...
    description: 'タスクで稼ぐ。リアルマネー。最低出金5,000円・即時付与。',
    images: ['/og-image.png'],
  },
  robots: {
    index: true,
